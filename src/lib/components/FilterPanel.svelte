...
<div class="glass-card rounded-2xl p-5 sm:p-6 mb-8 border border-[#774936]/15 shadow-sm">
	...
	<div class="flex items-center justify-between pb-4 mb-5 border-b border-[#774936]/15">
		<div class="flex items-center gap-2.5">
			<div class="w-8 h-8 rounded-lg bg-[#774936]/10 border border-[#774936]/20 flex items-center justify-center text-[#774936]">
		...
		{#if activeFilterCount > 0}
			<button
				...
				{disabled}
				class="inline-flex items-center gap-1.5 text-xs font-medium text-[#774936] hover:text-[#050609] transition-colors disabled:opacity-50 cursor-pointer"
			>
